...
class ToGo extends StatefulWidget {
  const ToGo({Key? key}) : super(key: key);

  @override
  ToGoState createState() => ToGoState();
}

class ToGoState extends State<ToGo> {
  @override
  void initState() {
    super.initState();
  }
          ...
          body: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Lleva tu servicio hasta donde tu usuario.',
                      style: TextStyle(
                  ...
                  Center(
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {},
                      label: const Text('Agregar zonas',
                          style: TextStyle(
                            fontSize: 16,
                            color: Color(0xff5bbdf7),
                          )),
